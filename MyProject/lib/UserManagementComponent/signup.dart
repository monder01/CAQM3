              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 50,
                    ), // مسافة بين العنوان وبداية حقول الإدخال
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        labelText:
                            "أدخل بريدك الإلكتروني الشخصي", // النص الإرشادي
                    ...
                    TextField(
                      controller:
                          phoneController, // ربط الحقل بمتحكم رقم الهاتف
                      decoration: InputDecoration(
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        final confirmed = await notify.showConfirmationDialog(
                          context,
                          'سيتم إنشاء حسابك الجديد بناءً على البيانات المدخلة.', // رسالة التأكيد المعروضة للمستخدم
                        );
                        if (!confirmed) {
                        ...
                        patient.phoneNumber = phoneController.text
                            .trim(); // حفظ رقم الهاتف
                        patient.role =
                            "Patient"; // تحديد دور المستخدم كـ "مريض"
